    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kids_image', models.ForeignKey(related_name='kids_image_release_set', blank=True, to='media.Image', help_text='Use this to override the default Release image.', null=True, on_delete=django.db.models.deletion.CASCADE)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('release', djangoplicity.translation.fields.TranslationForeignKey(to='releases.Release', on_delete=django.db.models.deletion.CASCADE)),
            ],
            options={
                'ordering': ('id',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('release', djangoplicity.translation.fields.TranslationForeignKey(verbose_name='Related release', to='releases.Release', on_delete=django.db.models.deletion.CASCADE)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('override_id', models.SlugField(null=True, verbose_name='Override ID', blank=True)),
                ('hide', models.BooleanField(default=False, verbose_name='Hide on kiosk')),
                ('archive_item', djangoplicity.translation.fields.TranslationForeignKey(verbose_name='Related Image Comparison', to='media.ImageComparison', on_delete=django.db.models.deletion.CASCADE)),
                ('release', djangoplicity.translation.fields.TranslationForeignKey(verbose_name='Related release', to='releases.Release', on_delete=django.db.models.deletion.CASCADE)),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('override_id', models.SlugField(null=True, verbose_name='Override ID', blank=True)),
                ('hide', models.BooleanField(default=False, verbose_name='Hide on kiosk')),
                ('archive_item', djangoplicity.translation.fields.TranslationForeignKey(verbose_name='Related Stock Image', to='media.Image', on_delete=django.db.models.deletion.CASCADE)),
                ('release', djangoplicity.translation.fields.TranslationForeignKey(verbose_name='Related release', to='releases.Release', on_delete=django.db.models.deletion.CASCADE)),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.ForeignKey(to='releases.Country', on_delete=django.db.models.deletion.CASCADE)),
                ('release', models.ForeignKey(to='releases.Release', on_delete=django.db.models.deletion.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postal_code', models.CharField(max_length=255, blank=True)),
                ('country', models.CharField(max_length=255, blank=True)),
                ('release', djangoplicity.translation.fields.TranslationForeignKey(to='releases.Release', only_sources=False, on_delete=django.db.models.deletion.CASCADE)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='release',
            name='release_type',
            field=djangoplicity.translation.fields.TranslationForeignKey(default=1, to='releases.ReleaseType', on_delete=django.db.models.deletion.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='release',
            name='source',
            field=djangoplicity.translation.fields.TranslationForeignKey(related_name='translations', verbose_name='Translation source', blank=True, to='releases.Release', null=True, only_sources=False, on_delete=django.db.models.deletion.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='release',
