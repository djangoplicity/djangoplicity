...
(function($){
	$.fn.extend({ 
		...
		var randID =  Math.round(Math.random()*100000000);
			...
			$('#beforeimage'+randID).css({'position':'absolute','top':'0px','left':'0px', 'max-width': imgWidth});
			$('#afterimage'+randID).css({'position':'absolute','top':'0px','right':'0px', 'max-width': imgWidth});
