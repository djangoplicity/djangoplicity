...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='page',
            name='section',
            field=models.ForeignKey(default=1, to='pages.Section', help_text='Determines e.g. which templates to use for rendering the template.', on_delete=django.db.models.deletion.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='page',
            name='source',
            field=djangoplicity.translation.fields.TranslationForeignKey(related_name='translations', verbose_name='Translation source', blank=True, to='pages.Page', null=True, only_sources=False, on_delete=django.db.models.deletion.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='embeddedpagekey',
            name='page',
            field=models.ForeignKey(blank=True, to='pages.Page', help_text='Select page that you want to use for the specific key. Note, only pages marked as embedded pages can be selected.', null=True, on_delete=django.db.models.deletion.CASCADE),
            preserve_default=True,
        ),
        migrations.CreateModel(
            name='PageProxy',
