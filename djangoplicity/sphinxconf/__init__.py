...
html_theme = "nature"
html_theme_options = {
    "footerbgcolor": "#003d82",
    "sidebarbgcolor": "#005ba0",
    "relbarbgcolor": "#000146",
    "linkcolor": "#f16600",
    "headtextcolor": "#003d82",
...
latex_documents = [
  ('index', 'Djangoplicity.tex', 'Djangoplicity Documentation', r'European Space Agency \& European Southern Observatory', 'manual'),
]
